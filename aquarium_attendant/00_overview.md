# Aquarium Attendant (એક્વેરિયમ એટેન્ડન્ટ) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Aquarium Attendant (એક્વેરિયમ એટેન્ડન્ટ) |
| **Organization** | Surat Municipal Corporation (SMC) |
| **Advertisement No.** | PRO/739, dated 11/03/2026 |
| **Total Vacancies** | 2 posts |
| **Pay Scale** | Pay Level 1: Rs.14,800 - 47,100 |
| **Age Limit** | 18-35 years |
| **Qualification** | 10th Pass + Swimming ability |
...
3. Select "Aquarium Attendant" post
