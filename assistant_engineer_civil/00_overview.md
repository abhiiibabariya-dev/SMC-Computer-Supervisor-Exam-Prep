# Assistant Engineer (Civil) (આસિસ્ટન્ટ ઈજનેર (સિવિલ)) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Assistant Engineer (Civil) (આસિસ્ટન્ટ ઈજનેર (સિવિલ)) |
...
| **Qualification** | Diploma/BE in Civil Engineering from recognized institution |
...
- Diploma/BE in Civil Engineering from recognized institution
...
3. Select "Assistant Engineer (Civil)" post
