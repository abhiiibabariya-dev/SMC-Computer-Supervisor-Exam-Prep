# Live Stock Inspector (લાઈવ સ્ટોક ઈન્સ્પેક્ટર) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Live Stock Inspector (લાઈવ સ્ટોક ઈન્સ્પેક્ટર) |
...
| **Qualification** | B.V.Sc (Bachelor of Veterinary Science) from recognized university |
...
- B.V.Sc (Bachelor of Veterinary Science) from recognized university
...
3. Select "Live Stock Inspector" post
