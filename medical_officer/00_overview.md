# Medical Officer (મેડિકલ ઓફિસર) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Medical Officer (મેડિકલ ઓફિસર) |
| **Organization** | Surat Municipal Corporation (SMC) |
| **Advertisement No.** | PRO/739, dated 11/03/2026 |
| **Total Vacancies** | 69 posts |
| **Pay Scale** | Pay Level 11: Rs.56,100 - 1,77,500 |
| **Age Limit** | 18-40 years (relaxation as per govt rules) |
| **Qualification** | MBBS from recognized university + Registration with Gujarat Medical Council |
...
- MBBS from recognized university + Registration with Gujarat Medical Council
