# Library Clerk (લાઈબ્રેરી ક્લાર્ક) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Library Clerk (લાઈબ્રેરી ક્લાર્ક) |
...
| **Qualification** | Graduate + Certificate/Diploma in Library Science from recognized institution |
...
- Graduate + Certificate/Diploma in Library Science from recognized institution
