# Deputy Engineer (Civil) (ડેપ્યુટી ઈજનેર (સિવિલ)) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Deputy Engineer (Civil) (ડેપ્યુટી ઈજનેર (સિવિલ)) |
...
| **Qualification** | BE/B.Tech in Civil Engineering from recognized university |
...
3. Select "Deputy Engineer (Civil)" post
