# Maintenance Assistant (Electrical) (મેઈન્ટેનન્સ આસિસ્ટન્ટ (ઈલેક્ટ્રિકલ)) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Maintenance Assistant (Electrical) (મેઈન્ટેનન્સ આસિસ્ટન્ટ (ઈલેક્ટ્રિકલ)) |
...
| **Qualification** | ITI in Electrician / Wireman trade from recognized institution |
...
- ITI in Electrician / Wireman trade from recognized institution
...
3. Select "Maintenance Assistant (Electrical)" post
