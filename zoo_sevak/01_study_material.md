# Zoo Sevak — Study Material (અભ્યાસ સામગ્રી)
## SMC Recruitment 2026 — Complete Study Guide

> **Exam Pattern**: 100 MCQs | 120 Minutes | -0.25 Negative Marking
> **Subjects**: Basic Animal Care, Cleaning & Maintenance, Zoo Rules, Gujarati Language, Basic Mathematics, General Knowledge

---

## Basic Animal Care

### Key Concepts in Basic Animal Care
- Study the fundamental principles of Basic Animal Care
- Practice problems and case studies related to Basic Animal Care
- Review previous year questions on Basic Animal Care
- Focus on practical applications in municipal corporation context


## Cleaning & Maintenance

### Key Concepts in Cleaning & Maintenance
- Study the fundamental principles of Cleaning & Maintenance
- Practice problems and case studies related to Cleaning & Maintenance
- Review previous year questions on Cleaning & Maintenance
- Focus on practical applications in municipal corporation context


## Zoo Rules

### Key Concepts in Zoo Rules
- Study the fundamental principles of Zoo Rules
- Practice problems and case studies related to Zoo Rules
- Review previous year questions on Zoo Rules
- Focus on practical applications in municipal corporation context
...
*Study material prepared for SMC Zoo Sevak Exam 2026*
