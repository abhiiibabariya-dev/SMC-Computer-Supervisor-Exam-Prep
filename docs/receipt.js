...
function autoReceipt(){
 ...
 var wait=window.firebase&&firebase.auth&&firebase.database?Promise.resolve():load('https://www.gstatic.com/firebasejs/12.17.1/firebase-app-compat.js').then(function(){return load('https://www.gstatic.com/firebasejs/12.17.1/firebase-auth-compat.js');}).then(function(){return load('https://www.gstatic.com/firebasejs/12.17.1/firebase-database-compat.js');});
