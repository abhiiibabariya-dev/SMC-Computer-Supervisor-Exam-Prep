# Assistant Engineer (Electrical) (આસિસ્ટન્ટ ઈજનેર (ઈલેક્ટ્રિકલ)) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Assistant Engineer (Electrical) (આસિસ્ટન્ટ ઈજનેર (ઈલેક્ટ્રિકલ)) |
...
| **Qualification** | Diploma/BE in Electrical Engineering from recognized institution |
...
- Diploma/BE in Electrical Engineering from recognized institution
...
3. Select "Assistant Engineer (Electrical)" post
