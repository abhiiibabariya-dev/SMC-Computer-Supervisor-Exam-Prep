# Assistant Engineer (Electrical) — Mock Test 1
...
**Q31.** Cement sets initially within:
- A) 30 min
- B) 60 min
- C) 90 min
- D) 120 min

**Q32.** The unit of pressure:
- A) Pascal
- B) Newton
- C) Joule
- D) Watt

**Q33.** Steel reinforcement in RCC resists:
- A) Compression
- B) Tension
- C) Both
- D) Neither
...
**Q36.** Dead load includes:
- A) Wind load
- B) Self weight
- C) Live load
- D) Earthquake

**Q37.** Modulus of elasticity units:
- A) N/mm²
- B) N/mm
- C) N·mm
- D) mm/N

**Q38.** Least count of steel tape:
- A) 1 mm
- B) 0.5 mm
- C) 0.1 mm
- D) 5 mm

**Q39.** Plinth level is above:
- A) Ground level
- B) Foundation
- C) Roof
- D) Lintel

**Q40.** DPC is provided at:
- A) Plinth level
- B) Lintel level
- C) Roof level
- D) Foundation

**Q41.** Grade of steel Fe500 means:
- A) 500 MPa yield
- B) 500 MPa ultimate
- C) 500 kg weight
- D) 500 mm size

**Q42.** Workability of concrete measured by:
- A) Slump test
- B) Compression test
- C) Tension test
- D) Flexure test

**Q43.** Curing time for concrete:
- A) 7 days min
- B) 3 days
- C) 1 day
- D) 14 days

**Q44.** Safe bearing capacity of hard rock:
- A) 3000 kN/m²
- B) 100 kN/m²
- C) 50 kN/m²
- D) 500 kN/m²

**Q45.** Survey instrument for measuring angles:
- A) Theodolite
- B) Level
- C) Chain
- D) Tape

**Q46.** Specific gravity of cement:
- A) 2.15
- B) 3.15
- C) 1.15
- D) 4.15

**Q47.** Fineness modulus of fine aggregate:
- A) 2.0-3.5
- B) 5.0-7.0
- C) 0.5-1.0
- D) 8.0-10.0

**Q48.** Maximum water absorption of brick:
- A) 15%
- B) 20%
- C) 25%
- D) 30%

**Q49.** Pointing is done on:
- A) External walls
- B) Internal walls
- C) Foundation
- D) Roof

**Q50.** The ratio for M15 concrete:
- A) 1:2:4
- B) 1:1.5:3
- C) 1:1:2
- D) 1:3:6

**Q51.** Shear force diagram is used to find:
- A) Bending stress
- B) Shear stress
- C) Deflection
- D) Torsion

**Q52.** Dampness in building causes:
- A) Efflorescence
- B) Strength increase
- C) Better finish
- D) None

**Q53.** Foundation depth depends on:
- A) Soil bearing capacity
- B) Building color
- C) Window size
- D) Door height

**Q54.** Plumb bob is used to check:
- A) Horizontality
- B) Verticality
- C) Level
- D) Slope
...
- B) Ready Cast Concrete
- C) Recycled Cement Compound
- D) None

**Q56.** Sand is classified by:
- A) Grain size
- B) Color
- C) Weight
- D) Smell

**Q57.** Aggregate in concrete provides:
- A) Strength and bulk
- B) Color
- C) Flexibility
- D) Waterproofing

**Q58.** Spirit level checks:
- A) Horizontality
- B) Weight
- C) Temperature
- D) Pressure

**Q59.** Scaffolding is used for:
- A) Temporary support during construction
- B) Permanent structure
- C) Decoration
- D) Storage

**Q60.** Efflorescence appears as:
- A) White deposit
- B) Black stain
- C) Green moss
- D) Red rust
...
| 31 | A | 32 | A | 33 | B | 34 | A | 35 | C | 36 | B | 37 | A | 38 | A | 39 | A | 40 | A |
| 41 | A | 42 | A | 43 | A | 44 | A | 45 | A | 46 | B | 47 | A | 48 | B | 49 | A | 50 | A |
...
*Mock Test 1 for SMC Assistant Engineer (Electrical) Exam 2026*
