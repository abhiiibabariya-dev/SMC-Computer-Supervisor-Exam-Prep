# Grade III Clerk (Audit) (ગ્રેડ-III ક્લાર્ક (ઓડિટ)) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Grade III Clerk (Audit) (ગ્રેડ-III ક્લાર્ક (ઓડિટ)) |
...
| **Qualification** | Graduate from recognized university + CCC/CCC+ Computer Certificate |
...
- Graduate from recognized university + CCC/CCC+ Computer Certificate
...
3. Select "Grade III Clerk (Audit)" post
