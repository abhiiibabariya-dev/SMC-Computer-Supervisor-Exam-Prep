# Technical Assistant (Bio Chemist) (ટેકનિકલ આસિસ્ટન્ટ (બાયો કેમિસ્ટ)) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Technical Assistant (Bio Chemist) (ટેકનિકલ આસિસ્ટન્ટ (બાયો કેમિસ્ટ)) |
...
| **Qualification** | B.Sc in Biochemistry / Chemistry from recognized university |
...
- B.Sc in Biochemistry / Chemistry from recognized university
...
3. Select "Technical Assistant (Bio Chemist)" post
