# Technical Assistant (Bio Chemist) — Study Material (અભ્યાસ સામગ્રી)
## SMC Recruitment 2026 — Complete Study Guide

> **Exam Pattern**: 100 MCQs | 120 Minutes | -0.25 Negative Marking
> **Subjects**: Biochemistry, Water Analysis, Lab Procedures, Chemical Testing, Instrumentation, General Knowledge
...
- Study the fundamental principles of Biochemistry
- Practice problems and case studies related to Biochemistry
- Review previous year questions on Biochemistry
- Focus on practical applications in municipal corporation context


## Water Analysis

### Key Concepts in Water Analysis
- Study the fundamental principles of Water Analysis
- Practice problems and case studies related to Water Analysis
- Review previous year questions on Water Analysis
- Focus on practical applications in municipal corporation context


## Lab Procedures

### Key Concepts in Lab Procedures
- Study the fundamental principles of Lab Procedures
- Practice problems and case studies related to Lab Procedures
- Review previous year questions on Lab Procedures
- Focus on practical applications in municipal corporation context


## Chemical Testing

### Key Concepts in Chemical Testing
- Study the fundamental principles of Chemical Testing
- Practice problems and case studies related to Chemical Testing
- Review previous year questions on Chemical Testing
- Focus on practical applications in municipal corporation context
...
- Study the fundamental principles of Instrumentation
- Practice problems and case studies related to Instrumentation
- Review previous year questions on Instrumentation
- Focus on practical applications in municipal corporation context
...
*Study material prepared for SMC Technical Assistant (Bio Chemist) Exam 2026*
