# Assistant Auditor (આસિસ્ટન્ટ ઓડિટર) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Assistant Auditor (આસિસ્ટન્ટ ઓડિટર) |
...
| **Qualification** | B.Com from recognized university |
...
3. Select "Assistant Auditor" post
