# Technical Assistant (Shark Pool) (ટેકનિકલ આસિસ્ટન્ટ (શાર્ક પુલ)) — SMC Recruitment 2026

## Post Details (પોસ્ટની વિગતો)

| Detail | Information |
|--------|-------------|
| **Post Name** | Technical Assistant (Shark Pool) (ટેકનિકલ આસિસ્ટન્ટ (શાર્ક પુલ)) |
...
| **Qualification** | B.Sc in Marine Biology / Zoology from recognized university |
...
- B.Sc in Marine Biology / Zoology from recognized university
...
3. Select "Technical Assistant (Shark Pool)" post
